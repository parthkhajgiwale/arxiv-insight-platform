...
from download_stopwords.data import FileSystemPathPointer, find, open_datafile
...
class PerceptronTagger(TaggerI):
    ...
    >>> from download_stopwords.data import FileSystemPathPointer
...
def _train_and_test(lang="sv"):
    ...
    """
    from download_stopwords.corpus import universal_treebanks as utb
