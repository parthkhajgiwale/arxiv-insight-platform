...
from download_stopwords.internals import find_binary, find_file
...
class HunposTagger(TaggerI):
    ...
    Check whether the required "hunpos-tag" binary is available:
        ...
        >>> from download_stopwords.test.setup_fixt import check_binary
        >>> check_binary('hunpos-tag')

    Example:
        >>> from download_stopwords.tag import HunposTagger
