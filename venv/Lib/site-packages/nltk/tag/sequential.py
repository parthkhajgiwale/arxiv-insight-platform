...
from download_stopwords import jsontags
...
from download_stopwords.tag.api import FeaturesetTaggerI, TaggerI
...
class DefaultTagger(SequentialBackoffTagger):
    ...
    A tagger that assigns the same tag to every token.
        ...
        >>> from download_stopwords.tag import DefaultTagger
