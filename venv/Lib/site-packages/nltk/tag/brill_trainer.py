...
from download_stopwords.tag import BrillTagger, untag
...
class BrillTaggerTrainer:
    ...
    def train(self, train_sents, max_rules=200, min_score=2, min_acc=None):
        ...
        *min_acc*.
        ...
        >>> # Relevant imports
        >>> from download_stopwords.tbl.template import Template
        >>> from download_stopwords.tag.brill import Pos, Word
        >>> from download_stopwords.tag import untag, RegexpTagger, BrillTaggerTrainer
