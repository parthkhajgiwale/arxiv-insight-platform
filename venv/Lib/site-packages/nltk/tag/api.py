...
from download_stopwords.internals import deprecated, overridden
from download_stopwords.metrics import ConfusionMatrix, accuracy
from download_stopwords.tag.util import untag
...
class TaggerI(metaclass=ABCMeta):
    ...
    def confusion(self, gold):
        ...
        >>> from download_stopwords.tag import PerceptronTagger
