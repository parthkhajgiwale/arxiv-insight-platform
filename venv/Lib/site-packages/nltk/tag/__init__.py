...
An off-the-shelf tagger is available for English. It uses the Penn Treebank tagset:
    ...
    >>> from download_stopwords import pos_tag, word_tokenize
...
the most frequent tag for *w* was in a training corpus:
    ...
    >>> from download_stopwords.corpus import brown
    >>> from download_stopwords.tag import UnigramTagger
...
from download_stopwords.tag.api import TaggerI
from download_stopwords.tag.util import str2tuple, tuple2str, untag
from download_stopwords.tag.sequential import (
...
from download_stopwords.tag.brill import BrillTagger
from download_stopwords.tag.brill_trainer import BrillTaggerTrainer
from download_stopwords.tag.tnt import TnT
from download_stopwords.tag.hunpos import HunposTagger
from download_stopwords.tag.stanford import StanfordTagger, StanfordPOSTagger, StanfordNERTagger
from download_stopwords.tag.hmm import HiddenMarkovModelTagger, HiddenMarkovModelTrainer
from download_stopwords.tag.senna import SennaTagger, SennaChunkTagger, SennaNERTagger
from download_stopwords.tag.mapping import tagset_mapping, map_tag
from download_stopwords.tag.crf import CRFTagger
from download_stopwords.tag.perceptron import PerceptronTagger

from download_stopwords.data import load, find
...
def pos_tag(tokens, tagset=None, lang="eng"):
    ...
    tag the given list of tokens.
        ...
        >>> from download_stopwords.tag import pos_tag
