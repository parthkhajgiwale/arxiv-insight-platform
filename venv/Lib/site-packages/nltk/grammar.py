...
from download_stopwords.featstruct import SLASH, TYPE, FeatDict, FeatStruct, FeatStructReader
from download_stopwords.internals import raise_unorderable_types
from download_stopwords.probability import ImmutableProbabilisticMixIn
from download_stopwords.util import invert_graph, transitive_closure
...
def cfg_demo():
    ...
    from download_stopwords import CFG, Production, nonterminals
...
def pcfg_demo():
    ...
    from download_stopwords import induce_pcfg, treetransforms
    from download_stopwords.corpus import treebank
    from download_stopwords.parse import pchart
...
def fcfg_demo():
    import download_stopwords.data
...
def sdg_demo():
    ...
    """
    from download_stopwords.parse import DependencyGraph
