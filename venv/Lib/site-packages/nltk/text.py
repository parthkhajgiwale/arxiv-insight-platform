...
from download_stopwords.collocations import BigramCollocationFinder
from download_stopwords.lm import MLE
from download_stopwords.lm.preprocessing import padded_everygram_pipeline
from download_stopwords.metrics import BigramAssocMeasures, f_measure
from download_stopwords.probability import ConditionalFreqDist as CFD
from download_stopwords.probability import FreqDist
from download_stopwords.tokenize import sent_tokenize
from download_stopwords.util import LazyConcatenation, cut_string, tokenwrap
...
class TokenSearcher:
    ...
    def findall(self, regexp):
        ...
        >>> from download_stopwords.text import TokenSearcher
        >>> from download_stopwords.book import text1, text5, text9
        >>> text5.findall("<.*><.*><bro>")
...
class Text:
    ...
    >>> import download_stopwords.corpus
    >>> from download_stopwords.text import Text
    ...
    def collocation_list(self, num=20, window_size=2):
        ...
        Return collocations derived from the text, ignoring stopwords.
            ...
            >>> from download_stopwords.book import text4
        ...
        if not (
            ...
            from download_stopwords.corpus import stopwords
    ...
    def dispersion_plot(self, words):
        ...
        """
        from download_stopwords.draw import dispersion_plot
...
class TextCollection(Text):
    ...
    >>> import download_stopwords.corpus
    >>> from download_stopwords.text import TextCollection
    >>> from download_stopwords.book import text1, text2, text3
