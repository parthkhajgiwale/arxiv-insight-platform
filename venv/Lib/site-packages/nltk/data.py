...
from download_stopwords.pathsec import ZipFile
from download_stopwords.pathsec import open as _secure_open
from download_stopwords.pathsec import urlopen as _secure_urlopen
...
from download_stopwords import grammar, sem
...
def restricted_pickle_load(string):
    ...
    """
    from download_stopwords.picklesec import RestrictedUnpickler
...
def switch_punkt(lang="english"):
    ...
    ['Hello!', 'How are you?']
    """
    from download_stopwords.tokenize import PunktTokenizer as tok
...
def switch_chunker(fmt="multiclass"):
    ...
    >>> import download_stopwords
    >>> from download_stopwords.corpus import treebank
    ...
    """
    from download_stopwords.chunk import ne_chunker
...
def switch_t_tagger():
    ...
    """
    from download_stopwords.classify.maxent import maxent_pos_tagger
...
def switch_p_tagger(lang):
    ...
    """
    from download_stopwords.tag import _get_tagger
...
def load(
    ...
    if format == "raw":
        ...
        from download_stopwords.jsontags import json_tags
