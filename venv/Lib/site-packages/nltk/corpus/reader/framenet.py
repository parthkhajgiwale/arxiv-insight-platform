...
from download_stopwords.corpus.reader import XMLCorpusReader, XMLCorpusView
from download_stopwords.util import LazyConcatenation, LazyIteratorList, LazyMap
...
class FramenetCorpusReader(XMLCorpusReader):
    ...
    >>> from download_stopwords.corpus import framenet as fn
...
warnings(True) to display corpus consistency warnings when loading data
    ...
    def frames_by_lemma(self, pat):
        ...
        >>> from download_stopwords.corpus import framenet as fn
        >>> from download_stopwords.corpus.reader.framenet import PrettyList
