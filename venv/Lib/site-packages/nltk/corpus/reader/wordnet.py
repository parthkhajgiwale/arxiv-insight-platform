...
from download_stopwords.corpus.reader import CorpusReader
from download_stopwords.internals import deprecated
from download_stopwords.probability import FreqDist
from download_stopwords.tag import map_tag
from download_stopwords.util import binary_search_file as _binary_search_file
...
class Synset(_WordNetObject):
 ...
 Synset('physical_entity.n.01'), Synset('entity.n.01')]
        ...
        from download_stopwords.util import acyclic_breadth_first
    ...
    def tree(self, rel, depth=-1, cut_mark=None):
        ...
        from download_stopwords.util import acyclic_branches_depth_first
...
class WordNetCorpusReader(CorpusReader):
    ...
    def index_sense(self, version=None):
        ...
        fn = "index.sense"
        if version:
            from download_stopwords.corpus import CorpusReader, LazyCorpusLoader
    ...
    def add_exomw(self):
        ...
        """
        from download_stopwords.corpus import extended_omw
    ...
    def digraph(
        ...
        <BLANKLINE>
        """
        from download_stopwords.util import edge_closure, edges2dot
