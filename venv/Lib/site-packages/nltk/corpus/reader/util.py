...
from download_stopwords.data import (
    FileSystemPathPointer,
    PathPointer,
    SeekableUnicodeStreamReader,
    ZipFilePathPointer,
)
from download_stopwords.internals import slice_bounds
from download_stopwords.tokenize import wordpunct_tokenize
from download_stopwords.util import AbstractLazySequence, LazyConcatenation, LazySubsequence
