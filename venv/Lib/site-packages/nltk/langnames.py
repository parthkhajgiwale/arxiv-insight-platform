...
are also available:
    ...
    >>> import download_stopwords.langnames as lgn
...
from download_stopwords.corpus import bcp47
...
def langname(tag, typ="full"):
    ...
    >>> from download_stopwords.langnames import langname
...
def langcode(name, typ=2):
    ...
    >>> from download_stopwords.langnames import langcode
