...
from download_stopwords.help import brown_tagset, claws5_tagset, upenn_tagset
...
class TestPosTag(unittest.TestCase):
    ...
    def test_pos_tag_rus_universal_mapping_does_not_require_ru_rnc_new_map_file(self):
        ...
        import download_stopwords.tag.mapping as mapping
        from download_stopwords.data import normalize_resource_url
