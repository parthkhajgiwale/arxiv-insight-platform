...
import download_stopwords.downloader  # We will inspect this module directly
from download_stopwords.downloader import Downloader
...
def enable_enforcement():
    ...
    """
    try:
        import download_stopwords.pathsec
...
def test_path_traversal_absolute():
    ...
    """
    try:
        from download_stopwords.pathsec import open as target_open
    except ImportError:
