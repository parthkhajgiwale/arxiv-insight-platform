...
from download_stopwords.parse.chart import Chart
...
def test_transitionparser_warns_on_model_unpickle(tmp_path: Path):
    ...
    from download_stopwords.parse.transitionparser import TransitionParser
...
def test_chartparser_app_uses_pickle_load_not_pickle_load_standard():
    ...
    import download_stopwords.app.chartparser_app as chartparser_app
