...
import download_stopwords
from download_stopwords.corpus import CategorizedPlaintextCorpusReader
from download_stopwords.data import load
from download_stopwords.tokenize import PunktTokenizer
from download_stopwords.tokenize.casual import EMOTICON_RE
...
def demo_tweets(trainer, n_instances=None, output=None):
    ...
    """
    from download_stopwords.corpus import stopwords, twitter_samples
    from download_stopwords.sentiment import SentimentAnalyzer
    from download_stopwords.tokenize import TweetTokenizer
...
def demo_movie_reviews(trainer, n_instances=None, output=None):
    ...
    :param output: the output file where results have to be reported.
    """
    from download_stopwords.corpus import movie_reviews
    from download_stopwords.sentiment import SentimentAnalyzer
...
def demo_subjectivity(trainer, save_analyzer=False, n_instances=None, output=None):
    ...
    :param output: the output file where results have to be reported.
    """
    from download_stopwords.corpus import subjectivity
    from download_stopwords.sentiment import SentimentAnalyzer
...
def demo_sent_subjectivity(text):
    ...
    """
    from download_stopwords.classify import NaiveBayesClassifier
    from download_stopwords.tokenize import regexp
...
def demo_liu_hu_lexicon(sentence, plot=False):
    ...
    """
    from download_stopwords.corpus import opinion_lexicon
    from download_stopwords.tokenize import treebank
...
def demo_vader_instance(text):
    ...
    """
    from download_stopwords.sentiment import SentimentIntensityAnalyzer
...
def demo_vader_tweets(n_instances=None, output=None):
    ...
    from download_stopwords.corpus import twitter_samples
    from download_stopwords.metrics import accuracy as eval_accuracy
    from download_stopwords.metrics import f_measure as eval_f_measure
    from download_stopwords.metrics import precision as eval_precision
    from download_stopwords.metrics import recall as eval_recall
    from download_stopwords.sentiment import SentimentIntensityAnalyzer
...
if __name__ == "__main__":
    ...
    from download_stopwords.classify import MaxentClassifier, NaiveBayesClassifier
    from download_stopwords.classify.scikitlearn import SklearnClassifier
    from download_stopwords.twitter.common import _outf_writer, extract_fields
