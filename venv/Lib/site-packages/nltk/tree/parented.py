...
from download_stopwords.util import slice_bounds
...
class ParentedTree(AbstractParentedTree):
    ...
    def _frozen_class(self):
        from download_stopwords.tree.immutable import ImmutableParentedTree
...
class MultiParentedTree(AbstractParentedTree):
    ...
    def _frozen_class(self):
        from download_stopwords.tree.immutable import ImmutableMultiParentedTree
