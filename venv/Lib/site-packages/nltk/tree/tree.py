...
from download_stopwords.grammar import Nonterminal, Production
...
class Tree(list):
    ...
    nested Tree.
        ...
        >>> from download_stopwords.tree import Tree
    ...
    def chomsky_normal_form(
        ...
        :type  parentChar: str
        """
        from download_stopwords.tree.transforms import chomsky_normal_form
    ...
    def un_chomsky_normal_form(
        ...
        :type  unaryChar: str
        """
        from download_stopwords.tree.transforms import un_chomsky_normal_form
    ...
    def collapse_unary(self, collapsePOS=False, collapseRoot=False, joinChar="+"):
        ...
        :type  joinChar: str
        """
        from download_stopwords.tree.transforms import collapse_unary
    ...
    def _frozen_class(self):
        from download_stopwords.tree.immutable import ImmutableTree
    ...
    def draw(self):
        ...
        """
        from download_stopwords.draw.tree import draw_trees
    ...
    def pretty_print(self, sentence=None, highlight=(), stream=None, **kwargs):
        ...
        """
        from download_stopwords.tree.prettyprinter import TreePrettyPrinter
...
def demo():
    ...
    from download_stopwords import ProbabilisticTree, Tree
