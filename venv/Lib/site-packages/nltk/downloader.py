...
from download_stopwords.pathsec import ZipFile, urlopen
...
class DownloaderGUI:
    ...
    def _init_widgets(self):
        ...
        from download_stopwords.draw.table import Table
...
def _find_packages(root):
    ...
    """
    from download_stopwords.corpus.reader.util import _path_from
