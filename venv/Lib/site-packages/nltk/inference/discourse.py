...
from download_stopwords.data import show_cfg
from download_stopwords.inference.mace import MaceCommand
from download_stopwords.inference.prover9 import Prover9Command
from download_stopwords.parse import load_parser
from download_stopwords.parse.malt import MaltParser
from download_stopwords.sem.drt import AnaphoraResolutionException, resolve_anaphora
from download_stopwords.sem.glue import DrtGlue
from download_stopwords.sem.logic import Expression
from download_stopwords.tag import RegexpTagger
...
class CfgReadingCommand(ReadingCommand):
    ...
    def parse_to_readings(self, sentence):
        ...
        from download_stopwords.sem import root_semrep
