...
from download_stopwords.classify.api import ClassifierI
from download_stopwords.classify.megam import call_megam, parse_megam_weights, write_megam_file
from download_stopwords.classify.tadm import call_tadm, parse_tadm_weights, write_tadm_file
from download_stopwords.classify.util import CutoffChecker, accuracy, log_likelihood
from download_stopwords.data import gzip_open_unicode
from download_stopwords.probability import DictionaryProbDist
from download_stopwords.util import OrderedDict
...
def load_maxent_params(tab_dir):
    ...
    from download_stopwords.data import open_datafile
    from download_stopwords.tabdata import MaxentDecoder
...
def save_maxent_params(wgt, mpg, lab, aon, tab_dir="/tmp"):
    ...
    from download_stopwords.tabdata import MaxentEncoder
...
def maxent_pos_tagger():
    from download_stopwords.data import find
    from download_stopwords.tag.sequential import ClassifierBasedPOSTagger
...
######################################################################
def demo():
    from download_stopwords.classify.util import names_demo
