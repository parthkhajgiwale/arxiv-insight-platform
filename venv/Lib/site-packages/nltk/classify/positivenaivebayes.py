...
Example:
    ...
    >>> from download_stopwords.classify import PositiveNaiveBayesClassifier
...
from download_stopwords.probability import DictionaryProbDist, ELEProbDist, FreqDist
...
def demo():
    from download_stopwords.classify.util import partial_names_demo
