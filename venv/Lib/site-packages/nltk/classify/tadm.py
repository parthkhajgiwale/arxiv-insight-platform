...
from download_stopwords.internals import find_binary
...
def names_demo():
    from download_stopwords.classify.maxent import TadmMaxentClassifier
...
def encoding_demo():
    ...
    from download_stopwords.classify.maxent import TadmEventMaxentFeatureEncoding
