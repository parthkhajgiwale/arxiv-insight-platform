...
from download_stopwords.classify.maxent import MaxentClassifier
from download_stopwords.classify.util import accuracy
...
def rte_classifier(algorithm, sample_N=None):
    from download_stopwords.corpus import rte as rte_corpus
