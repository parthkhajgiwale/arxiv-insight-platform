...
import download_stopwords.classify.util  # for accuracy & log_likelihood
from download_stopwords.util import LazyMap
...
def names_demo(trainer, features=names_demo_features):
    ...
    from download_stopwords.corpus import names
...
def wsd_demo(trainer, word, features, n=1000):
    ...
    from download_stopwords.corpus import senseval
