...
class ConditionalFreqDist(defaultdict):
    ...
    word type occurs, given the length of that word type:
        ...
        >>> from download_stopwords.probability import ConditionalFreqDist
        >>> from download_stopwords.tokenize import word_tokenize
...
class ConditionalProbDist(ConditionalProbDistI):
    ...
    distribution for each condition is an ``ELEProbDist`` with 10 bins:
        ...
        >>> from download_stopwords.probability import ConditionalFreqDist
        >>> from download_stopwords.probability import ConditionalProbDist, ELEProbDist
...
class ProbabilisticMixIn:
    ...
    parent classes.  For example:
        ...
        >>> from download_stopwords.probability import ProbabilisticMixIn
        >>> class A:
...
def gt_demo():
    from download_stopwords import corpus
