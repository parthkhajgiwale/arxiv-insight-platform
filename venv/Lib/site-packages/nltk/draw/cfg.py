...
from download_stopwords.draw.tree import TreeSegmentWidget, tree_to_treesegment
from download_stopwords.draw.util import (
    CanvasFrame,
    ColorizedList,
    ShowText,
    SymbolWidget,
...
from download_stopwords.grammar import CFG, Nonterminal, _read_cfg_production, nonterminals
...
def demo2():
    from download_stopwords import CFG, Nonterminal, Production
...
def demo():
    from download_stopwords import CFG, Nonterminal
...
def demo3():
    from download_stopwords import Production
