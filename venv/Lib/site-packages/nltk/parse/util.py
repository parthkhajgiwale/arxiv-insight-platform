...
from download_stopwords.grammar import CFG, PCFG, FeatureGrammar
from download_stopwords.parse.chart import Chart, ChartParser
from download_stopwords.parse.featurechart import FeatureChart, FeatureChartParser
from download_stopwords.parse.pchart import InsideChartParser
...
def taggedsent_to_conll(sentence):
    ...
    >>> from download_stopwords import word_tokenize, pos_tag
...
def taggedsents_to_conll(sentences):
    ...
    >>> from download_stopwords import word_tokenize, sent_tokenize, pos_tag
