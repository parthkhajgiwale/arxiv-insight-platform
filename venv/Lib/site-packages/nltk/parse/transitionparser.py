...
from download_stopwords.parse import DependencyEvaluator, DependencyGraph, ParserI
...
def demo():
    """
    >>> from download_stopwords.parse import DependencyGraph, DependencyEvaluator
    >>> from download_stopwords.parse.transitionparser import TransitionParser, Configuration, Transition
