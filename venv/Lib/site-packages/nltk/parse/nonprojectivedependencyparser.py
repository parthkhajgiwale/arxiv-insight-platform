...
class NaiveBayesDependencyScorer(DependencyScorerI):
    ...
    >>> from download_stopwords.parse.dependencygraph import DependencyGraph, conll_data2
...
class ProbabilisticNonprojectiveParser:
    ...
    >>> from download_stopwords.grammar import DependencyGrammar
...
def nonprojective_conll_parse_demo():
    from download_stopwords.parse.dependencygraph import conll_data2
