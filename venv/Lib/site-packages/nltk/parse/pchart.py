...
from download_stopwords.grammar import PCFG, Nonterminal
from download_stopwords.parse.api import ParserI
from download_stopwords.parse.chart import AbstractChartRule, Chart, LeafEdge, TreeEdge
from download_stopwords.tree import ProbabilisticTree, Tree
...
def demo(choice=None, draw_parses=None, print_parses=None):
    ...
    from download_stopwords import tokenize
