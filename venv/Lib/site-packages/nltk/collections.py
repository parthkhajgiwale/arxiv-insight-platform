...
from download_stopwords.internals import raise_unorderable_types, slice_bounds
...
class LazyMap(AbstractLazySequence):
    ...
    equivalent:
        ...
        >>> from download_stopwords.collections import LazyMap
        >>> function = str
        >>> sequence = [1,2,3]
...
class LazyZip(LazyMap):
    ...
    ``zip``.  In particular, an evaluated LazyZip is equivalent to a zip:
        ...
        >>> from download_stopwords.collections import LazyZip
...
class LazyEnumerate(LazyZip):
    ...
    equivalent:
        ...
        >>> from download_stopwords.collections import LazyEnumerate
...
class Trie(dict):
    ...
    def insert(self, string):
        ...
        >>> from download_stopwords.collections import Trie
        >>> trie = Trie(["abc", "def"])
