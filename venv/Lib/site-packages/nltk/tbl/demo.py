...
from download_stopwords.tag import BrillTaggerTrainer, RegexpTagger, UnigramTagger
from download_stopwords.tag.brill import Pos, Word
from download_stopwords.tbl import Template, error_list
...
def postag(
    ...
    if templates is None:
        from download_stopwords.tag.brill import brill24, describe_template_sets
