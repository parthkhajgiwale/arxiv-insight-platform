...
from download_stopwords.tokenize.api import StringTokenizer, TokenizerI
...
class SpaceTokenizer(StringTokenizer):
    ...
    which is the same as ``s.split(' ')``.
        ...
        >>> from download_stopwords.tokenize import SpaceTokenizer
        >>> s = "Good muffins cost $3.88\nin New York.  Please buy me\ntwo of them.\n\nThanks."
...
class TabTokenizer(StringTokenizer):
    ...
    the same as ``s.split('\t')``.
        ...
        >>> from download_stopwords.tokenize import TabTokenizer
...
class LineTokenizer(TokenizerI):
    ...
    This is similar to ``s.split('\n')``.
        ...
        >>> from download_stopwords.tokenize import LineTokenizer
        >>> s = "Good muffins cost $3.88\nin New York.  Please buy me\ntwo of them.\n\nThanks."
