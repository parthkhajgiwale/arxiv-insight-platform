...
money expressions, and any other non-whitespace sequences:
    ...
    >>> from download_stopwords.tokenize import RegexpTokenizer
...
that use pre-defined regular expressions.
    ...
    >>> from download_stopwords.tokenize import BlanklineTokenizer
    >>> # Uses '\s*\n\s*\n\s*':
...
All of the regular expression tokenizers are also available as functions:
    ...
    >>> from download_stopwords.tokenize import regexp_tokenize, wordpunct_tokenize, blankline_tokenize
...
from download_stopwords.tokenize.api import TokenizerI
from download_stopwords.tokenize.util import regexp_span_tokenize
...
class WordPunctTokenizer(RegexpTokenizer):
    ...
    non-alphabetic characters, using the regexp ``\w+|[^\w\s]+``.
        ...
        >>> from download_stopwords.tokenize import WordPunctTokenizer
        >>> s = "Good muffins cost $3.88\nin New York.  Please buy me\ntwo of them.\n\nThanks."
