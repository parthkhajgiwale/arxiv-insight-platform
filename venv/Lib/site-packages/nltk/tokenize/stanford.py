...
from download_stopwords.internals import _java_options, config_java, find_jar, java
from download_stopwords.parse.corenlp import CoreNLPParser
...
class StanfordTokenizer(TokenizerI):
    ...
    >>> from download_stopwords.tokenize.stanford import StanfordTokenizer
