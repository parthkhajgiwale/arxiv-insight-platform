...
from download_stopwords.corpus import perluniprops
from download_stopwords.tokenize.api import TokenizerI
from download_stopwords.tokenize.util import xml_unescape
...
class NISTTokenizer(TokenizerI):
    ...
    >>> from download_stopwords.tokenize.nist import NISTTokenizer
    >>> nist = NISTTokenizer()
