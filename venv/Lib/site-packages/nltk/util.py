...
from download_stopwords.collections import *
from download_stopwords.internals import deprecated, raise_unorderable_types, slice_bounds
from download_stopwords.pathsec import open as _secure_open
...
def edge_closure(tree, children=iter, maxdepth=-1, verbose=False):
    ...
    >>> from download_stopwords.util import edge_closure
...
def edges2dot(edges, shapes=None, attr=None):
    ...
    >>> from download_stopwords.util import edges2dot
...
def unweighted_minimum_spanning_digraph(tree, children=iter, shapes=None, attr=None):
    ...
    >>> from download_stopwords.util import unweighted_minimum_spanning_digraph as umsd
...
def acyclic_depth_first(
    ...
    >>> import download_stopwords
    >>> from download_stopwords.util import acyclic_depth_first as acyclic_tree
    >>> wn=nltk.corpus.wordnet
    >>> from pprint import pprint
...
def acyclic_branches_depth_first(
    ...
    >>> import download_stopwords
    >>> from download_stopwords.util import acyclic_branches_depth_first as tree
    >>> wn=nltk.corpus.wordnet
    >>> from pprint import pprint
...
def unweighted_minimum_spanning_dict(tree, children=iter):
    ...
    >>> import download_stopwords
    >>> from download_stopwords.corpus import wordnet as wn
    >>> from download_stopwords.util import unweighted_minimum_spanning_dict as umsd
    >>> from pprint import pprint
...
def unweighted_minimum_spanning_tree(tree, children=iter):
    ...
    >>> import download_stopwords
    >>> from download_stopwords.util import unweighted_minimum_spanning_tree as mst
    >>> wn=nltk.corpus.wordnet
    >>> from pprint import pprint
...
def flatten(*args):
    ...
    Flatten a list.
        ...
        >>> from download_stopwords.util import flatten
...
def ngrams(sequence, n, **kwargs):
    ...
    For example:
        ...
        >>> from download_stopwords.util import ngrams
...
def bigrams(sequence, **kwargs):
    ...
    For example:
        ...
        >>> from download_stopwords.util import bigrams
...
def trigrams(sequence, **kwargs):
    ...
    For example:
        ...
        >>> from download_stopwords.util import trigrams
