...
from download_stopwords.chunk.named_entity import Maxent_NE_Chunker
from download_stopwords.chunk.regexp import RegexpChunkParser, RegexpParser
from download_stopwords.chunk.util import (
    ChunkScore,
    accuracy,
    conllstr2tree,
    conlltags2tree,
...
def ne_chunk(tagged_tokens, binary=False):
    ...
    >>> from download_stopwords.chunk import ne_chunk
