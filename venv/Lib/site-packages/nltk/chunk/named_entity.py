...
from download_stopwords.tag import ClassifierBasedTagger, pos_tag

try:
    from download_stopwords.classify import MaxentClassifier
except ImportError:
    pass

from download_stopwords.chunk.api import ChunkParserI
from download_stopwords.chunk.util import ChunkScore
...
class NEChunkParserTagger(ClassifierBasedTagger):
    ...
    def _english_wordlist(self):
        try:
            ...
            from download_stopwords.corpus import words
...
class Maxent_NE_Chunker(NEChunkParser):
    ...
    def load_params(self):
        from download_stopwords.classify.maxent import BinaryMaxentFeatureEncoding, load_maxent_params
    ...
    def save_params(self):
        from download_stopwords.classify.maxent import save_maxent_params
