...
from download_stopwords.metrics import accuracy as _accuracy
from download_stopwords.tag.mapping import map_tag
from download_stopwords.tag.util import str2tuple
