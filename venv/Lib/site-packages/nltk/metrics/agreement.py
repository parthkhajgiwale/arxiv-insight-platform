...
Expected results from the Artstein and Poesio survey paper:
    ...
    >>> from download_stopwords.metrics.agreement import AnnotationTask
    >>> import os.path
...
from download_stopwords.metrics.distance import binary_distance
from download_stopwords.probability import ConditionalFreqDist, FreqDist
...
if __name__ == "__main__":
    ...
    from download_stopwords.metrics import distance
