...
from download_stopwords.draw import CFGEditor, TreeSegmentWidget, tree_to_treesegment
from download_stopwords.draw.util import CanvasFrame, EntryDialog, ShowText, TextWidget
from download_stopwords.parse import SteppingShiftReduceParser
from download_stopwords.tree import Tree
from download_stopwords.util import in_idle
...
def app():
    ...
    from download_stopwords.grammar import CFG, Nonterminal, Production
