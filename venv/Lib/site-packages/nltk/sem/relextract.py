...
def _join(lst, sep=" ", untag=False):
    ...
    try:
        ...
        from download_stopwords.tag import tuple2str
...
def in_demo(trace=0, sql=True):
    ...
    query.
    """
    from download_stopwords.corpus import ieer
...
def conllned(trace=1):
    ...
    from download_stopwords.corpus import conll2002
...
def ne_chunked():
    ...
    rels = []
    for i, sent in enumerate(download_stopwords.corpus.treebank.tagged_sents()[:1500]):
        sent = download_stopwords.ne_chunk(sent)
...
if __name__ == "__main__":
    ...
    from download_stopwords.sem import relextract
