...
from download_stopwords.sem import evaluate
...
def parse_sents(inputs, grammar, trace=0):
    ...
    from download_stopwords.parse import FeatureChartParser, load_parser
...
def root_semrep(syntree, semkey="SEM"):
    ...
    """
    from download_stopwords.grammar import FeatStructNonterminal
