...
try:
    ...
    from download_stopwords.draw.util import CanvasFrame, ShowText

except ImportError:
    """Ignore ImportError because tkinter might not be available."""

from download_stopwords.parse import MaltParser
from download_stopwords.sem.drt import DrsDrawer, DrtVariableExpression
from download_stopwords.sem.glue import DrtGlue
from download_stopwords.sem.logic import Variable
