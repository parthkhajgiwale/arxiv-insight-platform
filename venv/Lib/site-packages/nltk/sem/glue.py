...
from download_stopwords.internals import Counter
from download_stopwords.sem import drt, linearlogic
from download_stopwords.sem.logic import (
...
from download_stopwords.tag import BigramTagger, RegexpTagger, TrigramTagger, UnigramTagger
...
class Glue:
    def __init__(
        ...
        from download_stopwords import Prover9
    ...
    def dep_parse(self, sentence):
        ...
        if self.depparser is None:
            from download_stopwords.parse import MaltParser
