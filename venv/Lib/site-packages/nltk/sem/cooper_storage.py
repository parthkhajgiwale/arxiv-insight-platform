...
from download_stopwords.parse.featurechart import InstantiateVarsChart
from download_stopwords.sem.logic import ApplicationExpression, LambdaExpression, Variable
...
def demo():
    from download_stopwords.sem import cooper_storage as cs
